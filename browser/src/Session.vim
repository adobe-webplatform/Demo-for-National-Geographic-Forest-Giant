...
set ruler
set runtimepath=~/.vim,~/.vim/bundle/PIV,~/.vim/bundle/Solarized,~/.vim/bundle/WriteJSDocComment,~/.vim/bundle/ack,~/.vim/bundle/gundo,~/.vim/bundle/rainbow,~/.vim/bundle/scmdiff,~/.vim/bundle/tabular,/Applications/MacVim.app/Contents/Resources/vim/vimfiles,/Applications/MacVim.app/Contents/Resources/vim/runtime,/Applications/MacVim.app/Contents/Resources/vim/vimfiles/after,~/.vim/bundle/PIV/after,~/.vim/bundle/tabular/after,~/.vim/after
set scrolloff=8
set shiftwidth=4
set smartcase
set smartindent
...
silent only
cd ~/Documents/Projects/00-repos/github/adobe-webplatform/national-geographic-demo/browser/src
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 index.html
badd +0 sass/screen/_main.scss
badd +0 js/main.js
silent! argdel *
edit index.html
...
3
normal! 0
tabedit sass/screen/_main.scss
set splitbelow splitright
set nosplitright
wincmd t
set winheight=1 winwidth=1
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 88 - ((9 * winheight(0) + 27) / 55)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
88
